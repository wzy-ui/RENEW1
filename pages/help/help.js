...
Page({
      ...
      data: {
            list: [{
                        ...
                        title: '该程序收费吗？',
                        id: 1,
                        des: ['本程序是公益项目，目前暂时是不收取任何中介费的，您可以随心所欲地发布自己的闲置品和购买。如果您觉得本小程序不错，欢迎各位支持打赏我们，请我们喝阔落。'],
                        check: false,
                  }, {
                        title: '该程序是做什么的？',
                        id: 2,
                        des: ['本程序是面向深圳职业技术大学的同学，在这里，你可以上架你的闲置品，并进行合适出价，同时也可以在这里购买你满意的闲置品，双方协商之后就可以马上完成交易，能够快速处理掉不想要的东西，时效性高，变现速度快！该小程序现在是专门服务于深职大学生哦！'
                        ],
                        check: false,
                  }, {
                        title: '本程序的通知形式？',
